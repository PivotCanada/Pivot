...
function BusinessIndustry({
  ...
  const handleSubmit = async () => {
    let valid = await handleErrors(values, validateIndustry);
    if (valid) {
      const data = { industry: values.industry };
  ...
  return (
    <form className={classes.wrapper}>
      <div className={classes.container}>
        <h1 className={classes.header}>Your Industry</h1>

        <p className={classes.text}>What is your business's industry</p>
